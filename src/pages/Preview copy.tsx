  ...
  return (
    <div className="min-h-screen bg-gradient-warm">
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="max-w-3xl print-area mx-auto shadow-2xl border bg-white p-[100px]">
          <div ref={printRef} className="text-gray-900 font-serif leading-relaxed 11space-y-6">

            <p className="text-right font-semibold mb-10">તા. {convertToGujaratiDate(data.letterDate)}</p>

            <p className="text-center font-bold text-red-600 mb-10">।। जीवेत शरदः शतम् ।।</p>

            <p className="mb-7">સ્નેહીશ્રી, {data.recipientName}</p>

            <p className="mb-2">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {convertBirthDateToGujaratiFormat(data.birthDate)} તારીખે આવતા આપના જન્મદિવસ નિમિત્તે હાર્દિક શુભેચ્છાઓ...         </p>
            ...
            <p className="font-semibold mb-2">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; જન્મદિનની પુનઃ હાર્દિક શુભકામનાઓ...</p>

            <div className="mt-8">
              <p className="mb-2">
                <span>પ્રતિ,</span><br />
                <span>શ્રી {data.recipientName || "તમારો મિત્ર"}</span>
                <p>
