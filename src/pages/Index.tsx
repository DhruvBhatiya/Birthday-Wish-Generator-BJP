...
const Index = () => {
  ...
  const handleGenerate = () => {
    if (!formData.recipientName || !formData.letterDate || !formData.birthDate || !formData.address) {
      alert("Please fill in recipient's name, letter date, birth date, and address!");
      return;
    }
        ...
        <Card className="max-w-4xl mx-auto shadow-2xl border-0 bg-card/95 backdrop-blur-sm">
          ...
          <CardContent className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="letterDate" className="text-sm font-medium text-foreground">
                  Letter Date*
                </Label>
                <Input
                  id="letterDate"
